...
class SearchCardByQueryTest {
    ...
    fun searchCardByQueryTest() {
        ...
        searchAutoComplete.perform(replaceText("plague"), closeSoftKeyboard())

        val searchAutoComplete2 = onView(
            allOf(
                withId(com.bumptech.glide.R.id.search_src_text), withText("plague"),
                childAtPosition(
                    allOf(
                        withId(com.bumptech.glide.R.id.search_plate),
                        childAtPosition(
