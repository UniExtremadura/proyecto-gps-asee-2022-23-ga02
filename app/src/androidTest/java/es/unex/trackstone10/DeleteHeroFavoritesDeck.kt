...
class DeleteHeroFavoritesDeck {
    ...
    fun deleteHeroFavoritesDeck() {
        ...
        val appCompatButton3 = onView(
            allOf(
                withId(R.id.addHeroe_skinFavorite), withText("Add to favorites"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        val appCompatButton4 = onView(
            allOf(
                withId(R.id.addHeroe_skinFavorite), withText("Delete from Favorites"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
